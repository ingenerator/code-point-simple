<?php
/**
 * Defines PostcodeGeoCoderSpec - specifications for Ingenerator\CodePointSimple\PostcodeGeoCoder
 *
...
/**
 *
 * @see Ingenerator\CodePointSimple\PostcodeGeoCoder
 */
class PostcodeGeoCoderSpec extends ObjectBehavior
{
    const DB_BASE_DIR = './output';

    /**
     * Use $this->subject to get proper type hinting for the subject class
     * @var \Ingenerator\CodePointSimple\PostcodeGeoCoder
     */
    protected $subject;
    ...
    {
        $this->subject->shouldHaveType('Ingenerator\CodePointSimple\PostcodeGeoCoder');
    }

    /**
     * @param \Ingenerator\CodePointSimple\Helper\FileReader $file_reader
     */
    function it_encodes_partial_postcodes($file_reader)
    {
     ...
     * @param \Ingenerator\CodePointSimple\Helper\FileReader $file_reader
     */
    function it_encodes_complete_postcodes($file_reader)
    {
        $file_reader->json_read(self::DB_BASE_DIR . '/EH/41/3.json')->willReturn(array(
            'AA' => array('EH41', '3'),
            'AB' => array('EH41', '3')
        ));
        $file_reader->json_read(self::DB_BASE_DIR . '/EH/4/1.json')->willReturn(array(
            'AA' => array('EH4', '1'),
            'AB' => array('EH4', '1')
        ));
     ...
     * @param \Ingenerator\CodePointSimple\Helper\FileReader $file_reader
     */
    function it_returns_null_on_invalid_partial_postcodes($file_reader)
    {
        $file_reader->json_read(self::DB_BASE_DIR . '/EH/41/3.json')->willReturn(array(
            'AA' => array('EH41', '3'),
            'AB' => array('EH41', '3')
     ...
     * @param \Ingenerator\CodePointSimple\Helper\FileReader $file_reader
     */
    function it_returns_null_for_postcodes_in_wrong_format($file_reader)
    {
        $file_reader->json_read(self::DB_BASE_DIR . '/EH/41/centre.json')->willReturn(array('EH41', 'centre'));
